...
function _fetchCountryData() {
  _fetchCountryData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.get('https://restcountries.com/v2/all');
          case 3:
            result = _context.sent;
            countries = result.data; // sorteer de huidige data array op de populatie-property van elk land
            //       countries.sort((a, b) => {
